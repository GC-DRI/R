...
Create a new object called ```weight_kg``` and assign it the value **70**. Now, convert it to pounds, using the conversion factor **2.2**. Assign this new value to the object ```weight_lb```.
